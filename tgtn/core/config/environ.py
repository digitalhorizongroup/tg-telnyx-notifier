...
class Settings(BaseSettings):
    ...
    Attributes:
        ...
        history_days: Сколько суток отброшенные (неустранимая ошибка) сообщения
            лежат в базе. Отправленное удаляется сразу при уходе в канал, этот
            срок его не касается.
